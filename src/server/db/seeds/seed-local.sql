...
--
-- Seed users (passwords hashed with better-auth's Scrypt via hashPassword())
--
-- | Email                  | Password     | Role  |
-- |------------------------|--------------|-------|
...
-- Hashes generated with: hashPassword() from better-auth/crypto
...
-- ─── Subscriptions (free plan, active) ────────────────────────────────────────
